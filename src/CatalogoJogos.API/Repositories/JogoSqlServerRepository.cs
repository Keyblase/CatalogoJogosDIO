...
namespace CatalogoJogos.API.Repositories
{
    public class JogoSqlServerRepository : IJogoRepository
    {
        ...
        public async Task<List<JogoEntity>> Obter(int pagina, int quantidade)
        {
        ...
        public async Task<JogoEntity> Obter(Guid id)
        {
        ...
        public async Task<List<JogoEntity>> Obter(string nome, string produtora)
        {
            var jogos = new List<JogoEntity>();
        ...
        public async Task Inserir(JogoEntity jogo)
        {
        ...
        public async Task Atualizar(JogoEntity jogo)
        {
